...
in
{
  ...
  my.wireguardClient = {
    ...
    clientAddress = secrets.hosts.cane.domain;
    clientPrivateKeyFile = "/persist/secrets/modfin/wg/priv.key";
  };
  ...
  networking.hostName = "cane"; # Define your hostname.
  networking.hostId = "10181c92";
